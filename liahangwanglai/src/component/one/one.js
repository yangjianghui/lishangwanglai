                    ...
                    <div className="ss">
                        {
                            this.state.navList.map((item,index)=>{
                                ...
                                onClick={this.currentIndex.bind(this,index)}
                                className={this.state.current === index ? "activee":""}>{item}</span>
                            })
                        }
                    </div>
                    <div>
                ...
                <div>
                    {
                        this.state.content.map((item,index)=>{
                            return <ul key={index} className={index === this.state.current ? "active1" : ""}>
                                <li>{item}</li>
                            </ul>
                        })
                    }
